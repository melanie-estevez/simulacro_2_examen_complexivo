    ...
    <Container sx={{ mt: 3 }}>
      <Paper sx={{ p: 3 }}>
        ...
        <List dense>
          ...
          <ListItem><ListItemText primary="CRUD /api/puertas/ (admin, paginado en LIST)" /></ListItem>
          <ListItem><ListItemText primary="CRUD /api/vuelos/ (admin, paginado en LIST)" /></ListItem>
        </List>
